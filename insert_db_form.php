...
<head>
  ...
  <script type="text/javascript">
	function showtablecontent() {
		tablecon = document.getElementById("tablecontent");
...
<form action="db_insert.php" method="POST">
  ...
  <input type="button" name="show" value="show" onclick="showtablecontent()">
</form>
...
?>
      ...
      <table border=2 id="tablecontent" style="display: none;">
        <thead>
